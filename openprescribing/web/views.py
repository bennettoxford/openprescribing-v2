...
def _build_analysis_context(analysis):
    ...
    if analysis is not None:
        ...
        if isinstance(analysis.dtr_query, ListSizeQuery):
        ...
        url_parameters = urlencode(analysis.to_json_params())
    ...
    y = alt.Y(
        ...
        if analysis and (isinstance(analysis.dtr_query, ListSizeQuery))
        else "%",
    )
    stroke_width = (
