...
def build_chart_specs(dtr_is_list_size):
    ...
    return {
        "deciles_chart": (deciles_chart + org_chart).to_dict(),
        "all_orgs_line_chart": (all_orgs_line_chart + org_chart).to_dict(),
        "all_orgs_dots_chart": (all_orgs_dots_chart + org_chart).to_dict(),
    }
