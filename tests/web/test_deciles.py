...
def test_build_deciles_df(pdm):
    ...
    expected_df = pd.DataFrame(
        [
            ["2025-01-01", "p10", 2.0, (2, 6)],
            ["2025-01-01", "p20", 4.0, (2, 6)],
            ["2025-01-01", "p30", 6.0, (2, 6)],
            ["2025-01-01", "p40", 8.0, (2, 6)],
            # Note different dash style for median
            ["2025-01-01", "p50", 10.0, (6, 2)],
            ["2025-01-01", "p60", 12.0, (2, 6)],
            ["2025-01-01", "p70", 14.0, (2, 6)],
            ["2025-01-01", "p80", 16.0, (2, 6)],
            ["2025-01-01", "p90", 18.0, (2, 6)],
            ["2025-02-01", "p10", 3.0, (2, 6)],
            ["2025-02-01", "p20", 5.0, (2, 6)],
            ["2025-02-01", "p30", 7.0, (2, 6)],
            ["2025-02-01", "p40", 9.0, (2, 6)],
            # Note different dash style for median
            ["2025-02-01", "p50", 11.0, (6, 2)],
            ["2025-02-01", "p60", 13.0, (2, 6)],
            ["2025-02-01", "p70", 15.0, (2, 6)],
            ["2025-02-01", "p80", 17.0, (2, 6)],
            ["2025-02-01", "p90", 19.0, (2, 6)],
        ],
        columns=["month", "line", "value", "dash"],
    )
...
def test_build_org_df(pdm):
    ...
    expected_df = pd.DataFrame(
        [
            ...
            ["2025-01-01", "org", 5, (1, 0)],
            ["2025-02-01", "org", 6, (1, 0)],
        ],
        columns=["month", "line", "value", "dash"],
    )
